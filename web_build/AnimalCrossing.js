...
// include: /tmp/tmpgu1cs5do.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'bin/AnimalCrossing.data';
      var REMOTE_PACKAGE_BASE = 'AnimalCrossing.data';
...
Module['FS_createPath']("/", "shaders", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_bin/AnimalCrossing.data');
      }
      Module['addRunDependency']('datafile_bin/AnimalCrossing.data');
    ...
    loadPackage({"files": [{"filename": "/shaders/default.frag", "start": 0, "end": 15397}, {"filename": "/shaders/default.vert", "start": 15397, "end": 16733}], "remote_package_size": 16733});

  })();

// end include: /tmp/tmpgu1cs5do.js
// include: /tmp/tmpkw_fnqjo.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpkw_fnqjo.js
// include: /tmp/tmp7oq_jec6.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmp7oq_jec6.js
...
function findWasmBinary() {
  return locateFile('AnimalCrossing.wasm');
}
...
var dynCall_iff = makeInvalidEarlyAccess('dynCall_iff');
...
var dynCall_fiiiff = makeInvalidEarlyAccess('dynCall_fiiiff');
var dynCall_viiiifff = makeInvalidEarlyAccess('dynCall_viiiifff');
...
var dynCall_iiffii = makeInvalidEarlyAccess('dynCall_iiffii');
...
var dynCall_iifiiii = makeInvalidEarlyAccess('dynCall_iifiiii');
...
var dynCall_vifffiiiiii = makeInvalidEarlyAccess('dynCall_vifffiiiiii');
var dynCall_vifffiiii = makeInvalidEarlyAccess('dynCall_vifffiiii');
var dynCall_viffffiii = makeInvalidEarlyAccess('dynCall_viffffiii');
var dynCall_viffff = makeInvalidEarlyAccess('dynCall_viffff');
var dynCall_fiffffii = makeInvalidEarlyAccess('dynCall_fiffffii');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['dynCall_iff'] != 'undefined', 'missing Wasm export: dynCall_iff');
  ...
  assert(typeof wasmExports['dynCall_fiiiff'] != 'undefined', 'missing Wasm export: dynCall_fiiiff');
  assert(typeof wasmExports['dynCall_viiiifff'] != 'undefined', 'missing Wasm export: dynCall_viiiifff');
  ...
  assert(typeof wasmExports['dynCall_iiffii'] != 'undefined', 'missing Wasm export: dynCall_iiffii');
  ...
  assert(typeof wasmExports['dynCall_iifiiii'] != 'undefined', 'missing Wasm export: dynCall_iifiiii');
  ...
  assert(typeof wasmExports['dynCall_vifffiiiiii'] != 'undefined', 'missing Wasm export: dynCall_vifffiiiiii');
  assert(typeof wasmExports['dynCall_vifffiiii'] != 'undefined', 'missing Wasm export: dynCall_vifffiiii');
  ...
  assert(typeof wasmExports['dynCall_fiffffii'] != 'undefined', 'missing Wasm export: dynCall_fiffffii');
  ...
  dynCall_iff = dynCalls['iff'] = createExportWrapper('dynCall_iff', 3);
  ...
  dynCall_fiiiff = dynCalls['fiiiff'] = createExportWrapper('dynCall_fiiiff', 6);
  dynCall_viiiifff = dynCalls['viiiifff'] = createExportWrapper('dynCall_viiiifff', 8);
  ...
  dynCall_iiffii = dynCalls['iiffii'] = createExportWrapper('dynCall_iiffii', 6);
  ...
  dynCall_iifiiii = dynCalls['iifiiii'] = createExportWrapper('dynCall_iifiiii', 7);
  dynCall_iiiiiif = dynCalls['iiiiiif'] = createExportWrapper('dynCall_iiiiiif', 7);
  ...
  dynCall_vifffiiiiii = dynCalls['vifffiiiiii'] = createExportWrapper('dynCall_vifffiiiiii', 11);
  dynCall_vifffiiii = dynCalls['vifffiiii'] = createExportWrapper('dynCall_vifffiiii', 9);
  ...
  dynCall_fiffffii = dynCalls['fiffffii'] = createExportWrapper('dynCall_fiffffii', 8);
